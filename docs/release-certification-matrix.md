...
| COMBINED-01 | PR #747, #748, #749 y #750 aplicadas sobre la base #746 | APROBADO_LOCAL | 911 pruebas Jest, 4 reglas Firestore, 13 Playwright PC/movil, TypeScript, lint sin errores y build 259/259 paginas estaticas |
...
| INTERNAL-01 | Modulos internos restantes de empresa, planificacion y operacion no cubiertos arriba | VALIDACION_PARCIAL | 180/180 rutas estaticas y seis rutas centrales autenticadas PC/movil aprobadas; faltan controles y escrituras de modulos restantes |
