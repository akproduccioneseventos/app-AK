  ...
  describe('BLOQUE 1: getPublicInstagramFeed lee el historial guardado', () => {
    it('obtiene las publicaciones desde social-posts.json ordenadas de la más nueva a la más vieja', async () => {
      const mockPosts: Partial<SocialPost>[] = [
        ...
        {
          // Un borrador a medio escribir. NO puede salir en la web: se agrego el
          // 8 de septiembre de 2026, cuando se descubrio que salian todos.
          id: 'post-borrador',
          sourceId: '9001',
          platform: 'Instagram',
          status: 'Borrador',
          mediaUrl: 'https://instagram.com/borrador.jpg',
          mediaType: 'image',
          text: 'Borrador sin terminar',
          publishDate: '2026-08-25T15:00:00.000Z',
          performance: { likes: 0, comments: 0, shares: 0, views: 0 },
        },
        {
          // Programada para mas adelante: tampoco se adelanta sola.
          id: 'post-programado',
          sourceId: '9002',
          platform: 'Instagram',
          status: 'Programado',
          mediaUrl: 'https://instagram.com/programado.jpg',
          mediaType: 'image',
          text: 'Sale la semana que viene',
          publishDate: '2026-09-30T15:00:00.000Z',
          performance: { likes: 0, comments: 0, shares: 0, views: 0 },
        },
        {
          id: 'post-new',
