    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
            ...
            <Button asChild variant="outline" className="border-green-500 text-green-600 hover:bg-green-50"><Link href="/contabilidad/crm/outbox">
                <MessageCircle className="w-4 h-4 mr-2" />
                Cola de Mensajes
              </Link></Button>
            <Button asChild variant="outline"><Link href="/contabilidad/crm">
                 ...
                 meetingsForSelectedDay.length > 0 ? meetingsForSelectedDay.map(meeting => (
                    <div key={meeting.id} className="p-3 border rounded-md flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-muted/50">
                        ...
                        <div className="flex gap-2 shrink-0">
                            ...
                            <Button asChild variant="outline" size="sm"><Link href={`/contabilidad/crm?leadId=${meeting.id}`}>Ver en CRM</Link></Button>
                        </div>
                    </div>
