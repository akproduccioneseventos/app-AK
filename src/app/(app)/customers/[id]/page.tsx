    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2 w-full sm:w-auto flex-wrap">
            <Button asChild variant="outline" className="w-full"><Link href="/customers" className="flex-1 sm:flex-none"><ArrowLeft className="w-4 h-4 mr-2"/>Clientes</Link></Button>
            {whatsappUrl && (
             ...
             <Button asChild variant="default" className="w-full"><Link href={`/customers/${customerId}/edit`} className="flex-1 sm:flex-none">Editar Cliente</Link></Button>
      ...
      <Card className="border-indigo-200 bg-gradient-to-r from-indigo-50 to-violet-50 shadow-md">
        <CardContent className="py-4 px-6">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            {nextStepHref && (
              <Button asChild size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold uppercase tracking-widest text-xs"><Link href={nextStepHref}>
        ...
        <CardContent className="space-y-4">
            ...
            <div>
                 ...
                 <div className="flex flex-wrap gap-2">
                    ...
                    <Button asChild variant="secondary"><Link href="/settings/feedback"><Star className="w-4 h-4 mr-2"/>Ver Feedback</Link></Button>
                 </div>
            </div>
        </CardContent>
      </Card>
                    ...
                    <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-2 flex-wrap justify-end">
                          {eventDetail.presupuestoFiesta && (
                            <Button asChild variant="outline" size="sm" className="text-xs"><Link href={`/presupuestos/${eventDetail.presupuestoFiesta.id}/ver`}><FileText className="w-3 h-3 mr-1.5"/>Ver Presupuesto</Link></Button>
                          )}
                          {eventDetail.presupuestoFiesta && (
                            <Button asChild variant="outline" size="sm" className="text-xs"><Link href={`/presupuestos/${eventDetail.presupuestoFiesta.id}/estado-de-cuenta`}>
