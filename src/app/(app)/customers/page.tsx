                    ...
                    <TableRow key={customer.id}>
                      ...
                      <TableCell className="text-right print:hidden">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Button asChild variant="outline" size="icon" aria-label={`Ver Detalles de ${customer.companyName || customer.name}`} title="Ver Detalles"><Link href={`/customers/${customer.id}`}>
                              <Eye className="w-4 h-4" />
                            </Link></Button>
                          <Button asChild variant="outline" size="icon" aria-label={`Editar Cliente ${customer.companyName || customer.name}`} title="Editar Cliente"><Link href={`/customers/${customer.id}/edit`}>
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 print:hidden">
        ...
        <div className="flex gap-2 flex-wrap">
          <Button asChild variant="secondary"><Link href="/customers/reporte"><Printer className="w-4 h-4 mr-2" />Ver Reporte</Link></Button>
          <Button asChild><Link href="/customers/new">
          ...
          {isLoading ? (
            ...
            <>
             ...
             <div className="py-10 text-center print:hidden">
              ...
              {customers.length === 0 && (
                <Button asChild className="mt-6"><Link href="/customers/new">
                    <UserPlus className="w-5 h-5 mr-2" />
