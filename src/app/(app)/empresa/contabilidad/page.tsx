        ...
        {financialHubItems.map((item) => (
          <Card key={item.title} className="flex flex-col shadow-md hover:shadow-lg transition-shadow rounded-[1.5rem]">
            ...
            <CardFooter className="pt-3">
              <Button asChild variant="secondary" className="w-full rounded-xl"><Link href={item.href} className="w-full">
                  Acceder
                </Link></Button>
            </CardFooter>
          </Card>
         ...
         <Card className="flex flex-col shadow-md hover:shadow-lg transition-shadow rounded-[1.5rem]">
            ...
            <CardFooter className="pt-3 flex flex-col sm:flex-row gap-2">
              <Button asChild variant="secondary" className="w-full rounded-xl"><Link href="/simulador-de-presupuesto" className="w-full">
                  Ir al Simulador
                </Link></Button>
              <Button asChild variant="outline" className="w-full rounded-xl"><Link href="/settings/budget-display" className="w-full">
                  Configurar
                </Link></Button>
            </CardFooter>
          </Card>
