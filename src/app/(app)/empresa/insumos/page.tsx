      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 print:hidden">
        <div className="flex items-center gap-3">
         ...
         <div className="flex gap-2 flex-wrap">
            <Button asChild variant="secondary"><Link href="/empresa/insumos/reporte">
                    <Printer className="w-4 h-4 mr-2"/>Ver Reporte de Stock
                </Link></Button>
            <Button asChild variant="default"><Link href="/empresa/insumos/nuevo">
                            ...
                            <CardHeader className="pb-2 pt-3 px-3">
                              <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-1">
                                     <Button asChild variant="ghost" size="icon" className="h-7 w-7"><Link href={`/empresa/insumos/editar/${item.id}`}><Edit className="w-3.5 h-3.5"/></Link></Button>
                                      <AlertDialog>
