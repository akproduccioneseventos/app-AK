    ...
    <div className="space-y-10 pb-20">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
            <Button asChild variant="outline" className="rounded-xl font-bold"><Link href="/empresa/menus/tragos"><GlassWater className="w-4 h-4 mr-2"/>Módulo de Tragos</Link></Button>
            <Button asChild variant="secondary" className="rounded-xl font-bold"><Link href="/empresa/menus/catalogo">Catálogo de Platos</Link></Button>
            <Button asChild className="rounded-xl font-bold"><Link href="/empresa/menus/nuevo"><PlusCircle className="w-4 h-4 mr-2"/>Crear Menú</Link></Button>
            <Button asChild variant="outline" className="rounded-xl"><Link href="/empresa"><ArrowLeft className="w-4 h-4 mr-2" />Volver</Link></Button>
        </div>
      </div>
        ...
        <Card className="border-none shadow-2xl rounded-[2.5rem] overflow-hidden bg-white">
            ...
            {isLoading ? (
                ...
                <Card key={menu.id} className="flex flex-col border-none shadow-lg hover:shadow-xl transition-all duration-500 rounded-3xl overflow-hidden bg-white group hover:translate-y-[-4px]">
                    ...
                    <Button asChild variant="ghost" size="icon" className="h-9 w-9 rounded-xl text-primary hover:bg-white"><Link href={`/empresa/menus/${menu.id}/editar`}><Edit className="w-4 h-4"/></Link></Button>
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
