  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-screen text-center p-4">
          ...
          <Button asChild variant="outline" className="mt-4"><Link href="/empresa/menus">Volver</Link></Button>
      </div>
    );
  }
    ...
    <div className="bg-gray-100 print:bg-white py-6 print:py-0 font-sans">
      <div className="max-w-4xl mx-auto bg-white shadow-xl print:shadow-none p-6 md:p-10 print:p-2 relative">
        ...
        <div className="flex justify-between items-center mb-6 print:hidden">
          <Button asChild variant="outline" size="sm"><Link href="/empresa/menus"><ArrowLeft className="w-4 h-4 mr-1.5" />Volver a Menús</Link></Button>
