  ...
  return (
    <div className="space-y-8">
        ...
        {empresaHubItems.map((item) => (
          <Card key={item.title} className="flex flex-col shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardFooter className="pt-2">
              <Button asChild variant="secondary" className="w-full"><Link href={item.href} className="w-full">
                  {item.actionLabel}
                </Link></Button>
            </CardFooter>
          </Card>
      ...
      <div className="space-y-4">
        ...
        <Button asChild className="gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow"><Link href="/catalogo">
