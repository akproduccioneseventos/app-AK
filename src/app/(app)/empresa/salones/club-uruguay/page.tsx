    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 print:hidden">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Button asChild variant="outline"><Link href="/empresa/salones">
                      ...
                      {proximas.map((f) => (
                        <TableRow key={f.id}>
                          ...
                          <TableCell className="print:hidden">
                            <Button asChild variant="ghost" size="sm" className="h-7 text-xs"><Link href={`/fiestas/nueva/resumen-planificacion?fiestaId=${f.id}`}>
