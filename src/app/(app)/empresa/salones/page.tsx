    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Button asChild variant="outline" className="border-amber-300 text-amber-700 hover:bg-amber-50"><Link href="/empresa/salones/club-uruguay">
            ...
            <Card className="shadow-lg border-amber-200">
              ...
              <CardContent>
                ...
                <div className="mt-4 pt-4 border-t border-amber-100">
                  <Button asChild className="bg-amber-500 hover:bg-amber-600 text-white"><Link href="/empresa/salones/club-uruguay">
                      <Star className="w-4 h-4 mr-2" />
