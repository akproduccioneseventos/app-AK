    ...
    <div className="bg-slate-100 min-h-screen print:bg-white">
      ...
      <div className="py-2 px-4 print:hidden flex flex-col md:flex-row justify-between items-center gap-3 bg-white shadow-sm sticky top-0 z-50 border-b">
        <div className="flex items-center gap-2">
          <Button asChild variant="ghost" size="icon"><Link href={`/fiestas/nueva?fiestaId=${fiestaId}`}><ArrowLeft className="w-5 h-5" /></Link></Button>
          <div>
            ...
            <div className="p-4 overflow-y-auto">
              <Tabs defaultValue="general" className="space-y-4">
                ...
                <TabsContent value="carta" className="space-y-4">
                  ...
                  <Button asChild variant="outline" className="w-full"><Link href={`/fiestas/nueva/carta-tragos?fiestaId=${fiestaId}`}>Ir a lista de tragos</Link></Button>
                </TabsContent>
                ...
                <TabsContent value="menu" className="space-y-4">
                  ...
                  <Button asChild variant="outline" className="w-full"><Link href={`/fiestas/nueva/menu-mesa?fiestaId=${fiestaId}`}>Ir a lista de platos</Link></Button>
                </TabsContent>
