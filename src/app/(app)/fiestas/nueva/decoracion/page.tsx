    ...
    <div data-testid="decoracion-page" className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Button asChild variant="outline" disabled={isSaving}><Link href={`/fiestas/nueva/decoracion/pdf?fiestaId=${fiestaId}`}><FileText className="w-4 h-4 mr-2" />Ver PDF</Link></Button>
