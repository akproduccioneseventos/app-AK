  ...
  if (error) {
    return (
      <div className="max-w-xl mx-auto mt-10 text-center p-6 border-l-4 border-destructive bg-destructive/10">
        ...
        <Button asChild variant="secondary" className="mt-4"><Link href={`/fiestas/nueva/configuracion?fiestaId=${fiestaId}`}>Ir a Configuración</Link></Button>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 p-4 bg-white shadow-sm print:hidden sticky top-0 z-50 rounded-b-xl border-x border-b">
          <div className="flex items-center gap-3">
            <Button asChild variant="ghost" size="icon" className="rounded-full"><Link href={`/fiestas/nueva/gestion-documental?fiestaId=${fiestaId}`}><ArrowLeft className="w-5 h-5" /></Link></Button>
            <div>
