  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-center p-4">
        ...
        <Button asChild variant="outline" className="mt-4"><Link href={`/fiestas/nueva/gestion-documental?fiestaId=${fiestaId}`}>
    ...
    <div className="bg-slate-100 print:bg-white min-h-screen pb-20 print:pb-0">
      ...
      <div className="print:hidden sticky top-0 z-50 flex flex-col sm:flex-row justify-between items-center gap-3 px-4 py-3 bg-white shadow-sm border-b">
        <div className="flex items-center gap-3">
          <Button asChild variant="ghost" size="icon" className="rounded-full"><Link href={`/fiestas/nueva/gestion-documental?fiestaId=${fiestaId}`}>
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant={includeContrato ? 'default' : 'outline'}
              size="sm"
              className={cn(
                'text-[10px] font-black uppercase tracking-widest rounded-xl',
                includeContrato && 'bg-slate-900 text-white'
              )}
            ><Link href={`/fiestas/nueva/gestion-documental/recibo-pago?fiestaId=${fiestaId}&includeContrato=${includeContrato ? 'false' : 'true'}`}
          >
