    ...
    try {
      ...
      try {
        ...
        toast({
          ...
          description: `Tu navegador bloqueo el portapapeles. El enlace es: ${shareData.url}`,
        });
      }
    }
  };
  ...
  if (error || !fiesta) {
    return (
      <div className="p-8 max-w-xl mx-auto text-center bg-card rounded-2xl border shadow-sm my-12 space-y-4">
        ...
        <h2 className="text-xl font-bold text-foreground">Elegí una fiesta para ver el cronograma</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Para ver o imprimir el itinerario y cronograma de horarios minuto a minuto, seleccioná primero la fiesta correspondiente desde el listado general de eventos.
        </p>
        <div className="pt-2">
          <Button asChild>
    ...
    <div className="bg-gradient-to-b from-slate-100 to-slate-200 print:bg-white py-6 print:py-0 font-sans">
      <div className="max-w-3xl mx-auto bg-white shadow-xl print:shadow-none p-6 md:p-10 print:p-3 relative rounded-2xl print:rounded-none border border-slate-100">
        ...
        <div className="flex justify-between items-center mb-6 print:hidden">
          <Button asChild variant="outline" size="sm"><Link href={`/fiestas/nueva/itinerario?fiestaId=${fiestaId}`}><ArrowLeft className="w-4 h-4 mr-1.5" />Volver a Editar</Link></Button>
