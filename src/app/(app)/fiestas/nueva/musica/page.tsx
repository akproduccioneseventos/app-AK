...
function MusicaContent() {
  ...
  if (!fiestaId) {
    return (
      <EmptyStateModulo
        titulo="Música de la Fiesta"
        descripcion="Entrá a la música desde la fiesta: elegí el evento en el listado y abrí su planificador."
        fiestaId=""
      />
    );
  }
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
            ...
            <Button asChild variant="secondary"><Link href={`/fiestas/nueva/musica/pdf?fiestaId=${fiestaId}`}><Printer className="w-4 h-4 mr-2"/>Imprimir para DJ</Link></Button>
