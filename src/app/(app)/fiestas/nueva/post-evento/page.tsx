...
/** Returns true only if url is a valid http/https URL to prevent XSS. */
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <Card>
          <CardContent className="pt-6 text-center text-muted-foreground">
            ...
            <Button asChild variant="outline" size="sm"><Link href="/eventos" className="mt-4 inline-block"><ArrowLeft className="w-4 h-4 mr-2" />Ir a Eventos</Link></Button>
          </CardContent>
        </Card>
      </div>
    );
    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-1">
          <Button asChild variant="ghost" size="sm"><Link href={`/fiestas/nueva?id=${fiestaId}`}>
      ...
      <div className="space-y-6">
            ...
            {totalPresupuesto > 0 && (
              <div className="p-3 rounded-xl bg-indigo-50 border border-indigo-200">
                ...
                <p className={`text-lg font-black ${totalCobrado >= totalPresupuesto ? 'text-green-700' : 'text-red-700'}`}>
                  ...
                  {' '}
                  ({Math.round(((totalCobrado - totalPresupuesto) / totalPresupuesto) * 100)}%)
                </p>
              </div>
            )}
            <div className="mt-3">
              <Button asChild variant="outline" size="sm" className="w-full"><Link href={`/fiestas/nueva/gestion-costos-rentabilidad/reporte?id=${fiestaId}`}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {fiesta.galeriaEntregada && fiesta.galeriaUrl && isSafeUrl(fiesta.galeriaUrl) && (
        ...
        <Card>
          ...
          <CardContent>
            ...
            {npsScore !== null && (
              <div className={`p-3 rounded-lg border ${npsScore >= 9 ? 'bg-green-50 border-green-200' : npsScore >= 7 ? 'bg-yellow-50 border-yellow-200' : 'bg-red-50 border-red-200'}`}>
            ...
            <div className="mt-3">
              <Button asChild variant="outline" size="sm"><Link href={`/feedback/${fiestaId}`}>
