...
function ResumenImprimibleContent({ fiestaId }: { fiestaId: string | null }) {
  ...
  const handleDownloadJpg = async () => {
    ...
    try {
        ...
        link.download = `resumen-evento-${fiesta?.id.substring(0, 6)}.jpg`;
        link.href = canvas.toDataURL('image/jpeg', 0.9);
        link.click();
        toast({ title: "¡Descarga iniciada!", description: "La imagen del resumen se está descargando."});
    } catch(e) {
    ...
    <div className="bg-gray-100 print:bg-white py-6 print:py-0 font-sans">
      <div className="max-w-3xl mx-auto">
        <div className="flex justify-between items-center mb-6 print:hidden">
            <Button asChild variant="outline" size="sm"><Link href={`/fiestas/nueva?fiestaId=${fiestaId}`}><ArrowLeft className="w-4 h-4 mr-1.5" />Volver al Planificador</Link></Button>
        ...
        <div className="bg-white shadow-xl print:shadow-none p-6 md:p-10 print:p-2" ref={printRef}>
