            ...
            <Card className="border-none shadow-xl rounded-[2rem] overflow-hidden bg-white">
                <CardHeader className="bg-slate-900 text-white p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Button asChild variant="ghost" size="sm" className="h-7 text-[10px] font-black border border-white/20 text-white hover:bg-white/10"><Link href={`/fiestas/nueva/carga-operativa/pdf?fiestaId=${fiestaId}`} target="_blank">VER HOJA DE CARGA</Link></Button>
                    </div>
                </CardHeader>
            ...
            <Card className="border-none shadow-xl rounded-[2rem] overflow-hidden bg-white">
                <CardHeader className="bg-emerald-600 text-white p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Button asChild variant="ghost" size="sm" className="h-7 text-[10px] font-black border border-white/20 text-white hover:bg-white/10"><Link href={`/fiestas/nueva/catering/lista-compras?fiestaId=${fiestaId}`}>GESTIONAR COMPRAS</Link></Button>
                    </div>
                </CardHeader>
                <CardContent className="p-0">
                    <ScrollArea className="h-80">
