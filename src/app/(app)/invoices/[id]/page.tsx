  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 p-4 md:p-8 print:p-0 print:m-0">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 print:hidden">
        <Button asChild variant="outline"><Link href="/invoices"><ArrowLeft className="w-4 h-4 mr-2" />Volver</Link></Button>
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => window.print()}><Printer className="w-4 h-4 mr-2" />Imprimir Todo</Button>
          <Button asChild variant="secondary"><Link href={`/invoices/${invoice.id}/edit`}><Edit className="w-4 h-4 mr-2" />Editar</Link></Button>
        </div>
      </div>
