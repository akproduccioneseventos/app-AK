    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <Button asChild className="w-full sm:w-auto h-11"><Link href="/invoices/new" className="w-full sm:w-auto"><PlusCircle className="w-4 h-4 mr-2" />Nueva Factura</Link></Button>
            </div>
            <Card>
