  ...
  return (
    <div className="space-y-6 pb-20 max-w-2xl mx-auto">
      ...
      <header className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <Button asChild variant="outline" size="sm" className="rounded-xl h-10 px-3"><Link href="/">
                        ...
                        >
                          <div className="px-4 sm:px-5 pb-5 space-y-4">
                            ...
                            <div className="flex gap-2">
                              <Button asChild variant="outline" size="sm" className="w-full rounded-xl text-xs"><Link href={`/presupuestos/${p.id}/estado-de-cuenta`} className="flex-1">
                                  <Receipt className="w-3.5 h-3.5 mr-1.5" /> Estado de Cuenta
                                </Link></Button>
                              <Button asChild variant="outline" size="sm" className="w-full rounded-xl text-xs"><Link href={`/presupuestos/${p.id}/ver`} className="flex-1">
