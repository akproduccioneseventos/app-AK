    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Button asChild variant="secondary"><Link href="/proveedores/reporte"><Printer className="w-4 h-4 mr-2"/>Ver Reporte</Link></Button>
          <Button asChild><Link href="/proveedores/new">
              <UserPlus className="w-5 h-5 mr-2" />
              Añadir Registro
            </Link></Button>
           <Button asChild variant="outline"><Link href="/empresa"><ArrowLeft className="w-4 h-4 mr-2"/>Volver</Link></Button>
        </div>
      </div>
            ...
            <div className="overflow-x-auto">
                    ...
                    <TableRow key={proveedor.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Button asChild variant="outline" size="icon" aria-label={`Editar ${proveedor.nombreEmpresa || proveedor.nombre}`} title="Editar"><Link href={`/proveedores/${proveedor.id}/edit`}>
             ...
             <div className="py-10 text-center">
              ...
              {proveedores.length === 0 && (
                <Button asChild className="mt-6"><Link href="/proveedores/new">
                    <UserPlus className="w-5 h-5 mr-2" />
