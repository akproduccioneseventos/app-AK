    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button asChild><Link href="/empresa/servicios/nuevo">
              <PackagePlus className="w-4 h-4 mr-2" />
              Agregar Servicio
            </Link></Button>
          <Button asChild variant="outline"><Link href="/settings/budget-display">
              <Layers className="w-4 h-4 mr-2" />
              Configurar Paquetes
            </Link></Button>
          <Button asChild variant="outline"><Link href="/settings/ajuste-precios">
              <TrendingUp className="w-4 h-4 mr-2" />
              Ajuste de Precios
            </Link></Button>
          <Button asChild variant="ghost"><Link href="/settings">
