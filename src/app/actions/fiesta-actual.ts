// This file is deprecated and will be removed. Use the new actions in 'src/app/actions/fiesta/*' instead.
'use server';
...
import { updateConfiguracion as updateConfiguracionFiestaActual } from './fiesta/configuracion.actions';
