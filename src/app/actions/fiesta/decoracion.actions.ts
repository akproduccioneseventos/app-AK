...
async function updateFiestaData(updateFn: (data: FiestaEnPlanificacion) => FiestaEnPlanificacion): Promise<{ success: boolean; updatedData?: DecoracionData; error?: string }> {
  try {
    ...
    return { success: true, updatedData: updatedData.decoracion };
  } catch (e: any) {
    return { success: false, error: e.message };
  }
}

export async function updateDecoracion(decoracion: DecoracionData) {
