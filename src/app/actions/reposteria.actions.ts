...
async function updateFiestaData(updateFn: (data: FiestaEnPlanificacion) => FiestaEnPlanificacion): Promise<{ success: boolean; updatedData?: ReposteriaData; error?: string }> {
  try {
    ...
    return { success: true, updatedData: updatedData.reposteria };
  } catch (e: any) {
    return { success: false, error: e.message };
  }
}

export async function updateReposteria(reposteria: ReposteriaData) {
