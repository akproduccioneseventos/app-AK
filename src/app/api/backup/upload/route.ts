...
const RESTORABLE_COLLECTIONS = new Set([
  ...
  'cupones-usage.json',
  'feedback.json',
  'fiestas-historicas.json',
  'gastos-generales.json',
  'invitacion-digital-templates.json',
  'itinerary-templates.json',
  'menus-catering.json',
  'price-adjustments-history.json',
  'roles.json',
  'salon-layout-templates.json',
  'task-templates.json',
  'testimonials.json',
  'carga-operativa-master-template.json',
  'carga-operativa-templates.json',
  'meeting-checklist-template.json',
]);
