...
export const metadata: Metadata = createEventLandingMetadata({
  ...
  image: '/media/catalogo-servicios/cumpleanos_destacado.png',
...
export default function CumpleanosLanding() {
  return (
    <EventLandingPage
      ...
      heroImage="/media/catalogo-servicios/cumpleanos_destacado.png"
      ...
      detailImage="/media/catalogo-servicios/cumple-pista-01.jpeg"
