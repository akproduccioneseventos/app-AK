...
import { UserPlus, Edit, Trash2, Loader2, Users as UsersIcon } from 'lucide-react';
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
             ...
             <div className="py-10 text-center">
              ...
              <p className="text-muted-foreground text-lg">No tienes clientes guardados todavía.</p>
              <Link href="/customers/new" passHref>
