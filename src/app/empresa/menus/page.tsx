...
const BARRA_TRAGOS_BREAKDOWN = [
    { producto: "Licor de Frutilla", unidad: "Litros", cantPP: 0.02, costoKL: 300, costoPP: 6, cantTotal: 2, costoTotal: 600 },
    { producto: "Licor de Durazno", unidad: "Litros", cantPP: 0.02, costoKL: 300, costoPP: 6, cantTotal: 2, costoTotal: 600 },
    { producto: "Jugo de Durazno", unidad: "Litros", cantPP: 0.02, costoKL: 50, costoPP: 1, cantTotal: 2, costoTotal: 100 },
    { producto: "Licor blue", unidad: "Litros", cantPP: 0.02, costoKL: 300, costoPP: 6, cantTotal: 2, costoTotal: 600 },
    { producto: "Fernet", unidad: "Litros", cantPP: 0.04, costoKL: 400, costoPP: 16, cantTotal: 4, costoTotal: 1600 },
    { producto: "Granadina", unidad: "Litros", cantPP: 0.01, costoKL: 220, costoPP: 2.2, cantTotal: 1, costoTotal: 220 },
    { producto: "Lata durazno", unidad: "Unidades", cantPP: 0.03, costoKL: 80, costoPP: 2.4, cantTotal: 3, costoTotal: 240 },
    { producto: "lata anana", unidad: "Unidades", cantPP: 0.05, costoKL: 117, costoPP: 5.85, cantTotal: 5, costoTotal: 585 },
    { producto: "Pepsi", unidad: "Litros", cantPP: 0.14, costoKL: 90, costoPP: 12.6, cantTotal: 14, costoTotal: 1260 },
    { producto: "vasos y sorvitos", unidad: "Unidades", cantPP: 3, costoKL: 2, costoPP: 6, cantTotal: 300, costoTotal: 600 },
    { producto: "Refresco lima barato", unidad: "Litros", cantPP: 0.02, costoKL: 65, costoPP: 1.3, cantTotal: 2, costoTotal: 130 },
    { producto: "Vodka", unidad: "Litros", cantPP: 0.03, costoKL: 280, costoPP: 8.4, cantTotal: 3, costoTotal: 840 },
    { producto: "Ron", unidad: "Litros", cantPP: 0.02, costoKL: 300, costoPP: 6, cantTotal: 2, costoTotal: 600 },
    { producto: "Limon", unidad: "Gramos", cantPP: 20, costoKL: 70, costoPP: 1.4, cantTotal: 2000, costoTotal: 140 },
    { producto: "Frutilla", unidad: "Gramos", cantPP: 20, costoKL: 120, costoPP: 2.4, cantTotal: 2000, costoTotal: 240 },
    { producto: "Azucar", unidad: "Gramos", cantPP: 20, costoKL: 70, costoPP: 1.4, cantTotal: 2000, costoTotal: 140 },
    { producto: "Caña", unidad: "Litros", cantPP: 0.02, costoKL: 300, costoPP: 6, cantTotal: 2, costoTotal: 600 },
    { producto: "Jugo de naranja", unidad: "Litros", cantPP: 0.1, costoKL: 35, costoPP: 3.5, cantTotal: 10, costoTotal: 350 },
];
