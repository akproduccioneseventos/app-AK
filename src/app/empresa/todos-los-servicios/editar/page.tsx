...
export default function EditarItemInventarioPage({ params: paramsProp }: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (formData.tipoItem === 'Servicio' && (formData.calculationMethod === 'fijo' ? !formData.precioVenta : false)) {
        toast({ title: "Precio Requerido", description: "El precio de venta es obligatorio para servicios con precio fijo.", variant: "destructive" });
        return;
    }
