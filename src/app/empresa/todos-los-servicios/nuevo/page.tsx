...
import { ArrowLeft, PlusCircle, Save, Loader2, PackagePlus, ListFilter, StickyNote } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Completa la información para registrar un nuevo activo o insumo en el inventario.</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="item-nombre" className="text-base">Nombre del Ítem *</Label>
              <Input id="item-nombre" value={nombre} onChange={(e) => setNombre(e.target.value)} placeholder="Ej: Silla Tiffany, Harina 0000, Foco LED" className="text-base p-3" required disabled={isSaving}/>
            </div>
