...
export default function BoguePage() {
  ...
  const processBoomerangVideo = async (frames: HTMLCanvasElement[]) => {
    ...
    try {
      ...
      const colorDeAcento = fiesta?.branding?.accentColor || '#ec4899';
      
      const stripUrl = await componerTiraDeFotos({
        fotos: fotosBase64,
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        // Auto Upload
        await handleAutoUpload(videoBlob, stripUrl);
      };
