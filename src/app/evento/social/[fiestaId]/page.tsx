  ...
  return (
    <Card className="shadow-lg overflow-hidden flex flex-col bg-card">
      ...
      <CardContent className="p-0 flex-grow">
        <WatermarkedImage containerClassName="aspect-square relative bg-muted" src={post.imageUrl} alt={`Foto de ${post.authorName}`} layout="fill" objectFit="cover" data-ai-hint="event photo" />
      </CardContent>
             ...
             <Dialog open={isUploadDialogOpen} onOpenChange={setIsUploadDialogOpen}>
                ...
                <DialogContent>
                    ...
                    <form onSubmit={handleUploadSubmit} className="space-y-4">
                        {uploadPreview ? <div className="relative aspect-video"><NextImage src={uploadPreview} alt="Vista previa" layout="fill" objectFit="contain" className="rounded-md border"/></div>
