...
const TOUCHPIX_THEMES = [
  ...
  { id: 'disco_glam', label: 'Brillo Glam', emoji: '🪩', gradient: 'from-fuchsia-600 to-purple-800', cssFilter: 'brightness(1.1) contrast(1.1) saturate(1.3)', description: 'Brillo disco' },
  ...
  { id: 'pop_art', label: 'Arte Pop', emoji: '🎨', gradient: 'from-yellow-500 to-red-600', cssFilter: 'saturate(2.5) contrast(1.4) brightness(1.05)', description: 'Estilo pop' },
  { id: 'golden_luxury', label: 'Lujo Exclusivo', emoji: '👑', gradient: 'from-amber-500 to-yellow-700', cssFilter: 'sepia(0.5) saturate(1.5) brightness(1.1) contrast(1.1)', description: 'Dorado premium' },
];
...
export default function TouchpixPage() {
  ...
  const tabs: { id: TabMode; label: string; emoji: string; icon: React.ReactNode }[] = [
    ...
    { id: 'faceswap', label: 'Cambiar Cara', emoji: '🎭', icon: <Users className="w-5 h-5" /> },
