        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2"><Label htmlFor="direccion-lugar" className="text-base">Dirección del Lugar</Label><Input id="direccion-lugar" value={(config as any).direccionLugar || ''} onChange={(e) => handleChange('direccionLugar' as any, e.target.value)} placeholder="Ej: Av. Libertador 1234, Montevideo" className="text-base p-3" disabled={isSaving}/></div>
              <div className="space-y-2"><Label htmlFor="google-maps-url" className="text-base">Link Google Maps</Label><Input id="google-maps-url" type="url" value={(config as any).googleMapsUrl || ''} onChange={(e) => handleChange('googleMapsUrl' as any, e.target.value)} placeholder="https://maps.google.com/..." className="text-base p-3" disabled={isSaving}/></div>
            </div>
