      ...
      <Card className="shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-lg">
            La planificación del diseño y decoración estará disponible próximamente.
          </CardDescription>
        </CardHeader>
        <CardContent className="text-center">
          <p className="text-muted-foreground">
            Define la temática, paleta de colores, arreglos florales y todos los detalles visuales de tu fiesta.
          </p>
          <img 
            src="https://placehold.co/600x400.png" 
            alt="Diseño y decoración en construcción" 
            className="mt-6 rounded-md shadow-md mx-auto"
            data-ai-hint="event decoration planning"
          />
        </CardContent>
      </Card>
    </div>
