...
import { getFiestaActual, updateNumerosMesa as updateNumerosMesaAction } from '@/app/actions/fiesta-actual';
            ...
            return (
                <div key={pageIndex} className="w-[210mm] h-[297mm] mx-auto my-4 bg-white shadow-lg print:shadow-none print:my-0 print:mx-auto print:break-after-page p-4 flex flex-col">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-4 mt-4">
                        <MenuComponent tableNumber={tableNum1} inverted fiesta={fiesta} data={data} logoUrl={logoUrl}/>
                        {tableNum2 <= tableCount && (
                            <MenuComponent tableNumber={tableNum2} inverted fiesta={fiesta} data={data} logoUrl={logoUrl}/>
                        )}
                    </div>
                    <div className="flex-1 grid grid-cols-2 gap-4 mt-4">
                        <MenuComponent tableNumber={tableNum1} fiesta={fiesta} data={data} logoUrl={logoUrl}/>
                        {tableNum2 <= tableCount && <MenuComponent tableNumber={tableNum2} fiesta={fiesta} data={data} logoUrl={logoUrl}/>}
                    </div>
                </div>
            );
        })}
