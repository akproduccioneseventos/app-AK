...
const internalModules: PlanningModule[] = [
  ...
  { title: "Feedback y Testimonios", description: "Gestiona las encuestas de clientes y genera testimonios con IA.", href: "/settings/feedback", status: "Disponible", actionLabel: "Gestionar Feedback" },
  { title: "Catering y Menú del Evento", description: "Selecciona el menú y planifica la repostería y bebidas para el evento.", icon: ChefHat, href: "/fiestas/nueva/catering", status: "Disponible", actionLabel: "Gestionar Catering" },
