...
const internalModules: PlanningModule[] = [
  ...
  { title: "Planificador Gastronómico", description: "Calcula costos de repostería y bebidas.", icon: Calculator, href: "/fiestas/nueva/planner-costo-fiesta/reposteria", status: "Disponible", actionLabel: "Abrir Calculadora" },
