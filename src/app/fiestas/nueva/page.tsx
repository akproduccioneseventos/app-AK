...
const modules = [
  ...
  // Portal del Cliente
  { id: 'portalCliente', title: "Portal del Cliente", href: "portal-cliente", icon: KeyRound, description: "Gestiona la experiencia del cliente.", category: 'Portal del Cliente' },
  ...
  { id: 'mesasCliente', title: "Asignación de Mesas (Cliente)", href: "/portal/mesas", icon: Users, description: "Vista del cliente para organizar mesas.", category: 'Portal del Cliente' },
