...
const portalModuleGroups: ModuleGroup[] = [
  {
    label: 'A. Portada y comunicación',
    emoji: '🏠',
    modules: [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'menu', label: 'Menú / Comida' },
      { id: 'fotografiaYFilmacion', label: 'Fotos y filmación' },
      { id: 'dressCode', label: 'Dress code' },
      { id: 'listaRegalos', label: 'Lista de regalos' },
      { id: 'videoVida', label: 'Video de vida' },
      { id: 'invitados', label: 'Invitados y mesas' },
      { id: 'calculadoraBebidas', label: 'Lo que debe traer el cliente' },
      { id: 'ubicacion', label: 'Ubicación del evento' },
      { id: 'simuladorInvitados', label: 'Agregar invitados (simulador)' },
    ],
  },
  {
    label: 'C. Panel Financiero',
    emoji: '💳',
    modules: [
      { id: 'pagos', label: 'Pagos y saldo' },
      { id: 'informarPago', label: 'Informar pago' },
