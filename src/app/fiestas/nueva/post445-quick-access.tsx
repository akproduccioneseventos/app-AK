...
import { BadgeDollarSign, GitPullRequest, KeyRound, Monitor, Sparkles } from 'lucide-react';
...
export function Post445QuickAccess() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-3 z-50 mx-auto max-w-5xl rounded-2xl border border-slate-200 bg-white/95 p-2 shadow-2xl backdrop-blur supports-[backdrop-filter]:bg-white/80">
