          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b" style={{ background: `linear-gradient(135deg, ${eventColor}18, ${eventColor}08)` }}>
              <div className="flex items-center gap-2">
                ...
                {programa.length > 0 && (
                  <span className="text-xs font-semibold px-2 py-0.5 rounded-full text-white" style={{ backgroundColor: eventColor }}>
                    {programa.length} momentos
                  </span>
                )}
              </div>
              <button
            ...
            <div className="overflow-y-auto flex-1 px-5 py-4">
              {programa.length === 0 ? (
                <div className="text-center py-10 text-muted-foreground">
                  ...
                  <p className="font-semibold text-sm">El itinerario estará disponible próximamente.</p>
                </div>
              ) : (
