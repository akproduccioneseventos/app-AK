    ...
    <main className="min-h-screen bg-white text-slate-950">
                ...
                >
                  ...
                  <div className={cn('relative z-10 grid h-full gap-4 p-5 text-white sm:p-7', isSmallDevice ? 'grid-cols-1 content-between' : 'grid-cols-[1.1fr_0.9fr] items-end')}>
                    <div className="max-w-2xl">
                      <span className="inline-flex items-center gap-2 rounded-full bg-white/14 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.18em] backdrop-blur">
                      ...
                      <p className={cn('mt-4 max-w-xl font-medium text-white/82', deviceMode === 'mobile' ? 'text-sm leading-6' : 'text-lg leading-8')}>
                    ...
                    <div className={cn('grid gap-3', isSmallDevice ? 'grid-cols-1' : 'grid-cols-2')}>
                      {TECHNOLOGY_STEPS.slice(0, isSmallDevice ? 3 : 4).map((step) => (
                        <div key={step.id} className="rounded-2xl border border-white/18 bg-white/12 p-3 backdrop-blur-md">
            ...
            <div className="grid gap-5 xl:grid-cols-[1fr_430px]">
                  ...
                  return (
                    <motion.button
                      ...
                      className={cn(
                        ...
                        isActive ? 'border-red-500 shadow-xl shadow-red-900/10' : 'border-slate-200 hover:border-red-200 hover:shadow-lg hover:shadow-slate-950/8',
                      )}
                    >
              ...
              <AnimatePresence mode="wait">
                <motion.aside
                  ...
                  className="overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-950 text-white shadow-2xl shadow-slate-950/18"
                >
                  <div className="relative aspect-[9/13] overflow-hidden">
                    ...
                    <div className="absolute inset-x-5 top-5 flex items-center justify-between">
                      <span className="rounded-full bg-white/14 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.18em] backdrop-blur">Vista cliente</span>
                      <Heart className="h-5 w-5 text-red-300" />
                    </div>
                    <div className="absolute inset-x-5 bottom-5">
                      <p className="text-[10px] font-black uppercase tracking-[0.22em] text-white/62">{activeStep.eyebrow}</p>
                      ...
                      <p className="mt-5 text-sm font-medium leading-6 text-white/72">{activeStep.description}</p>
                    </div>
                  </div>
                </motion.aside>
              </AnimatePresence>
      ...
      <section id="invitaciones" className="bg-slate-950 py-20 text-white sm:py-24">
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
          <div className="mb-10 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/8 px-4 py-2 text-[11px] font-black uppercase tracking-[0.22em] text-red-200">
            ...
            <p className="max-w-xl text-base font-medium leading-7 text-white/66">
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {INVITATION_TEMPLATES.map((template, index) => (
              <motion.article
                ...
                className="group overflow-hidden rounded-[2rem] border border-white/12 bg-white/8 shadow-2xl shadow-black/20"
              >
                <div className="relative aspect-[4/5] overflow-hidden">
                  ...
                  <div className="absolute left-4 right-4 top-4 flex items-center justify-between">
                    <span className="rounded-full bg-white/16 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.18em] backdrop-blur">Demo</span>
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="mt-2 text-sm font-bold text-white/76">{template.mood}</p>
                  </div>
                </div>
                <div className="p-5">
                  <p className="text-sm font-medium leading-6 text-white/68">{template.description}</p>
                  <div className="mt-5 flex items-center justify-between rounded-2xl border border-white/10 bg-white/8 p-3">
                    <span className="text-[10px] font-black uppercase tracking-[0.18em] text-white/48">Foto reemplazable</span>
