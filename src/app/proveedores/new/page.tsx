...
export default function NewProveedorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const proveedorData: Omit<Customer, 'id' | 'email' | 'salesFunnelStage' | 'estadoCliente'> = { 
      ...
      address: {
        ...
        // Los otros campos de dirección (city, zipCode, etc.) se omiten según la solicitud anterior
      },
    };
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="proveedor-phone" type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+598 9X XXX XXX" />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="street" value={street} onChange={(e) => setStreet(e.target.value)} placeholder="Ej: Av. Principal 1234" />
            </div>
          </CardContent>
