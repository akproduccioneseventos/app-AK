...
export const metadata: Metadata = createEventLandingMetadata({
  ...
  image: '/media/catalogo-servicios/fiesta_15_destacada.png',
...
export default function QuinceanerasLanding() {
  return (
    <EventLandingPage
      ...
      heroImage="/media/catalogo-servicios/fiesta_15_destacada.png"
      ...
      detailImage="/media/catalogo-servicios/fiesta-15-pista-01.jpeg"
