...
import { ArrowLeft, UserPlus2, LogIn } from "lucide-react";
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-primary/10 to-background p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center space-y-3">
          ...
          <CardDescription>Únete para gestionar tus eventos fácilmente.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="name">Nombre Completo</Label>
            <Input id="name" placeholder="Tu Nombre Apellido" required />
          </div>
          <div className="space-y-2">
