...
export function AuthGuard({ children }: AuthGuardProps) {
  // Para reactivar la protección por contraseña, descomenta las siguientes líneas y el formulario de inicio de sesión a continuación.
  ...
  // Protección por contraseña temporalmente desactivada
  return <>{children}</>;
}

// Función auxiliar para despachar un evento de cierre de sesión (puede ser llamada desde AppShell)
export function triggerAppLogout() {
  // Esto ya no tendrá un efecto visible hasta que se reactive la lógica de autenticación.
