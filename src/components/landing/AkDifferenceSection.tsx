...
const benefits = [
  {
    ...
    text: 'AK coordina salon, servicios, tiempos, proveedores, equipo y detalles para que la familia no cargue con todo.',
    icon: ClipboardList,
  },
  {
    title: 'Todos los servicios conectados',
    text: 'Decoracion, catering, DJ, foto, video, entretenimiento, pantalla, invitacion y portal trabajan bajo una misma planificacion.',
    icon: Sparkles,
  },
  {
    title: 'Salon y produccion en un lugar',
    text: 'La propuesta no queda partida entre proveedores sueltos: el cliente ve una solucion completa y controlada.',
    icon: Gem,
  },
  {
    title: 'Equipo organizador presente',
    text: 'Antes, durante y despues del evento hay responsables cuidando agenda, pagos, cambios, montaje y cierre.',
    icon: Users,
  },
];

const differentiators = [
  'Una sola reunion puede ordenar presupuesto, salon, servicios y proximos pasos.',
  ...
  'Despues del evento quedan galeria, recuerdos y contenido para compartir.',
];
    ...
    <section className="overflow-hidden bg-slate-950 py-24 text-white">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[.92fr_1.08fr] lg:px-8">
        <div className="space-y-7">
          <div>
            <p className="mb-4 text-xs font-black uppercase tracking-[0.35em] text-amber-200">Por que AK es diferente</p>
            ...
            <p className="mt-5 max-w-xl text-lg font-semibold leading-relaxed text-white/65">
              ...
              ni llegar al dia del evento con dudas. La experiencia se piensa como un sistema completo.
            </p>
          </div>
        ...
        <div className="space-y-5">
            ...
            <div className="grid gap-4 md:grid-cols-[.9fr_1.1fr]">
              <div className="relative min-h-[360px] overflow-hidden rounded-[1.6rem]">
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950/90 to-transparent p-5">
                  <p className="text-xs font-black uppercase tracking-[0.25em] text-white/60">Equipo de organizacion</p>
          ...
          <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/10 p-4">
            ...
            <p className="text-sm font-bold leading-relaxed text-white/70">
              La venta se apoya en tranquilidad: fecha, salon, servicios, presupuesto y coordinacion quedan claros desde el inicio.
            </p>
          </div>
        </div>
      </div>
