...
export function BlogSection() {
  ...
  return (
    <section id="blog" className="py-24 bg-zinc-950 overflow-hidden text-white border-y border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-6">
          ...
          <Link
            href="/public/blog"
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 px-6 py-3.5 text-xs font-black uppercase tracking-widest text-white transition-all hover:scale-[1.02] active:scale-95 shrink-0"
          >
            ...
            return (
              <motion.div key={post.slug} variants={cardVariants} className="h-full">
                <Link
                  ...
                  className="group flex flex-col justify-between h-full rounded-3xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] p-8 shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden"
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <h3 className="mt-3 text-xl font-black leading-tight text-white group-hover:text-indigo-400 transition-colors duration-200">
                        {post.title}
                      </h3>
