        ...
        <div className="max-w-3xl">
          {promoActiva ? (
            ...
            <motion.div
              {...reveal}
              transition={reduceMotion ? undefined : { duration: 0.5, delay: 0.05 }}
              className="mb-4 inline-flex items-center gap-2.5 rounded-full border border-red-500/30 bg-red-950/40 px-3.5 py-1.5 text-[11px] font-black uppercase tracking-widest text-red-200 backdrop-blur-md shadow-[0_0_15px_rgba(239,68,68,0.2)]"
            >
              <span className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-red-400 opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-red-500 shadow-[0_0_8px_#ef4444]" />
              </span>
              <span>AK PRODUCCIONES // SISTEMA DE EVENTOS 2026</span>
            </motion.div>
          )}
          ...
          >
            ...
            Salto, Uruguay · Experiencia integral
          </motion.p>
