    ...
    <section className="py-24 bg-zinc-950" id="proceso">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-red-400 text-xs font-black uppercase tracking-widest mb-6 backdrop-blur">
            🚀 Cómo Trabajamos
          </div>
        ...
        <div className="hidden md:flex items-start justify-between relative">
          {/* Connector line */}
          <div className="absolute top-10 left-[16.66%] right-[16.66%] h-0.5 bg-gradient-to-r from-purple-500/40 via-red-500/40 to-amber-500/40" />
          ...
          {steps.map((step, i) => (
            <div key={i} className="flex flex-col items-center text-center w-1/3 px-6 relative">
              ...
              <div className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-zinc-950 border-2 border-red-600/40 flex items-center justify-center text-xs font-black text-red-400 z-10">
                {i + 1}
              </div>
            ...
            <div key={i} className="flex gap-4">
              ...
              <div className="pt-2 pb-4">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-black text-red-400 uppercase tracking-widest">Paso {i + 1}</span>
                </div>
