...
// This component is no longer used as service selection has been revamped.
// Keeping the file to avoid breaking imports immediately, but it can be deleted.
export default function Paso3Servicios_DEPRECATED() {
  return null;
}
