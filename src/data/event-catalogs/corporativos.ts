...
const corporativosData: EventCatalogData = {
  ...
  hero: {
    ...
    subheadline:
      'Reuniones de empresa, cenas de fin de año, team building, lanzamientos de producto â€” los organizamos con la elegancia y profesionalismo que tu empresa merece.',
  ...
  gallery: [
    ...
    { id: 'g2', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Decoración corporativa' },
    ...
    { id: 'g5', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Salón preparado', size: 'wide' },
