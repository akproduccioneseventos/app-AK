...
const fiestasData: EventCatalogData = {
  ...
  hero: {
    ...
    subheadline:
      'Cumpleaños, despedidas, graduaciones, reuniones temáticas â€” organizamos la celebración perfecta a tu medida, sea grande o íntima.',
  ...
  testimonials: [
    {
      ...
      source: 'instagram',
      text: 'Organizamos el cumple de 50 de mi mamá con AK y fue increíble. Decoración espectacular, la comida riquísima y el DJ hizo bailar a todos. ¡Gracias! ðŸŽŠ',
      date: 'Mayo 2024',
    },
    {
      id: 't2',
  ...
  gallery: [
    { id: 'g1', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Salón decorado para fiesta', size: 'wide' },
    { id: 'g2', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Torta de cumpleaños' },
    { id: 'g3', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'DJ en acción' },
    { id: 'g4', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Mesa temática decorada' },
