...
const xvAnosData: EventCatalogData = {
  ...
  testimonials: [
    {
      ...
      source: 'instagram',
      text: '¡La fiesta de mis XV fue como un cuento de hadas! Gracias AK por hacer todo tan perfecto. Mis amigas no podían creerlo. ðŸ‘‘âœ¨',
      date: 'Junio 2024',
    },
    {
      id: 't2',
  ...
  promotion: {
    ...sharedPromotion,
    sectionTitle: 'ðŸŽ Regalos especiales para la quinceañera',
    gifts: [
  ...
  gallery: [
    { id: 'g1', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Salón decorado para XV', size: 'wide' },
    { id: 'g2', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Trono de quinceañera' },
    { id: 'g3', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Torta de XV años' },
    { id: 'g4', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Vals de quinceañera' },
    { id: 'g5', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Decoración floral', size: 'wide' },
    { id: 'g6', src: '/media/salon-discoteca-ak-01.jpeg', alt: 'Quinceañera con amigas' },
  ],
  whyUs: sharedWhyUs,
  process: sharedProcess,
  whatsappNumber: '59899123456',
  whatsappMessage:
    '¡Hola AK Producciones! Quiero cotizar una FIESTA DE XV AÃ‘OS. Me gustaría conocer sus paquetes.',
};
