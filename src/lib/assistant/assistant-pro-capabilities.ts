...
const AGENT_PROFILES: AssistantAgentProfile[] = [
  ...
  },
  {
    ...
    routes: ['/contabilidad/crm', '/settings/google-workspace', '/contabilidad/crm/agenda'],
  ...
  },
  {
    ...
    routes: ['/fiestas/nueva/decoracion', '/fiestas/nueva/carga-operativa', '/empresa/salones/experiencia-visual'],
