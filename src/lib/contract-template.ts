/**
 * AK Producciones Eventos - Legal Contract Template
 *
...
DÉCIMO TERCERA: PRESUPUESTO Y MODIFICACIONES POSTERIORES
Se adjunta a éste contrato el presupuesto final de los servicios contratados, sus costos individuales y el total a pagar por el cliente, el cual será firmado por ambas partes y las mismas reconocen y aceptan éste presupuesto como el acuerdo final de los servicios y costos. Toda modificación, reducción, agregado o ajuste de los servicios contratados deberá realizarse por escrito y con la firma de ambas partes. No se aceptarán modificaciones informales, ya sea de palabra, por mensajes o cualquier otro medio no formalizado. Cualquier modificación que implique un ajuste económico se documentará en una adenda al presente contrato, donde constarán los cambios y el nuevo valor acordado.

DÉCIMO CUARTA: RESPONSABILIDAD DE IMPUESTOS
El cliente asume la totalidad del pago correspondiente a Agadu; el Prestador no asume responsabilidad por el incumplimiento o multa por éste concepto.

DÉCIMO QUINTA: JURISDICCIÓN
Para cualquier conflicto derivado del presente contrato, ambas partes acuerdan someterse a la competencia de los Juzgados Letrados de Salto, constituyendo domicilio en los indicados al inicio del documento.

DÉCIMO SEXTA: DISPOSICIONES FINALES
Las partes declaran haber leído, comprendido y aceptado todas y cada una de las cláusulas del presente contrato, firmando dos ejemplares de un mismo tenor y a un solo efecto. En señal de conformidad, ambas partes firman el presente contrato.`;

/**
 * Fill the contract template with actual event data.
 */
export function fillContractTemplate(vars: {
  ciudadFecha?: string;
