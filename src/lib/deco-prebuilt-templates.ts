...
export const DECO_PREBUILT_TEMPLATES: DecoCanvasTemplate[] = [
  ...
  },
  {
    ...
    creadoEn: PRESET_DATE,
    elementos: [
      el('hw_1', 'globosMacizos', 200, 180, ['#FF8C00', '#7B68EE', '#000000'], 1),
      el('hw_2', 'globosMacizos', 700, 180, ['#FF8C00', '#7B68EE', '#000000'], 1),
      el('hw_3', 'corazon', 450, 130, ['#FF4500'], 3),
      el('hw_4', 'mariposa', 380, 230, ['#7B68EE', '#000000'], 2, -20, 1.2),
      el('hw_5', 'mariposa', 520, 230, ['#7B68EE', '#000000'], 2, 20, 1.2),
    ],
  },
  {
    id: 'preset_navidad',
