...
export const defaultBebidasCategorias: BebidaCategoria[] = [
  ...
  {
    id: 'barra_tragos', nombreDisplay: 'Barra de Tragos', activada: true, items: [], recetas: [
      {
        id: 'receta_coctel_100p',
        nombre: 'Coctel 100 Personas - 50 Litros',
        capacidadBaseLt: 50,
        porcionesBase: 100,
        costoTotalReceta: 2910,
        ingredientes: [
