...
export const defaultListaDeCargaOperativaCategorias: CargaOperativaCategoria[] = [
    { id: 'cat_vajilla_1', nombre: 'Vajilla y Cocina', items: [
        { id: 'lc_1', nombre: 'Platos de Sitio', cantidad: '120', cargado: false },
        { id: 'lc_2', nombre: 'Platos Grandes', cantidad: '120', cargado: false },
        { id: 'lc_3', nombre: 'Platos Chicos', cantidad: '120', cargado: false },
        { id: 'lc_4', nombre: 'Cucharitas', cantidad: '120', cargado: false },
        { id: 'lc_5', nombre: 'Tenedores', cantidad: '120', cargado: false },
        { id: 'lc_6', nombre: 'Cuchillos', cantidad: '120', cargado: false },
        { id: 'lc_84', nombre: 'Cucharas de Postre', cantidad: '120', cargado: false },
        { id: 'lc_85', nombre: 'Tenedores de Postre', cantidad: '120', cargado: false },
        { id: 'lc_86', nombre: 'Cuchillos de Postre', cantidad: '120', cargado: false },
        { id: 'lc_87', nombre: 'Tazas de Café', cantidad: '120', cargado: false },
        { id: 'lc_88', nombre: 'Platillos de Café', cantidad: '120', cargado: false },
        { id: 'lc_89', nombre: 'Cucharitas de Café', cantidad: '120', cargado: false },
        { id: 'lc_7', nombre: 'Espátula de Torta', cantidad: '4', cargado: false },
        { id: 'lc_8', nombre: 'Jarras Chicas', cantidad: '1 Caja', cargado: false },
        { id: 'lc_9', nombre: 'Jarras Grandes', cantidad: '4 Cajas', cargado: false },
        { id: 'lc_10', nombre: 'Vasos', cantidad: '4 Cajas', cargado: false },
        { id: 'lc_90', nombre: 'Copas de Agua', cantidad: '120', cargado: false },
        { id: 'lc_91', nombre: 'Copas de Vino', cantidad: '120', cargado: false },
        { id: 'lc_92', nombre: 'Copas de Champagne', cantidad: '120', cargado: false },
        { id: 'lc_11', nombre: 'Copas de Brindis', cantidad: '2 Cajas', cargado: false },
        ...
        { id: 'lc_12', nombre: 'Hieleras Grandes', cantidad: '16', cargado: false },
        { id: 'lc_13', nombre: 'Hieleras Chicas', cantidad: '1', cargado: false },
        { id: 'lc_18', nombre: 'Pinzas de Hieleras', cantidad: 'Caja Negra', cargado: false },
        ...
        { id: 'lc_24', nombre: 'Freidora', cantidad: '2 Cajas', cargado: false },
        { id: 'lc_item_olla_50l', nombre: 'Olla 50 Litros', cantidad: '1', cargado: false },
        { id: 'lc_item_colador_g', nombre: 'Colador Grande', cantidad: '1', cargado: false },
        { id: 'lc_23', nombre: 'Platinas', cantidad: 'Caja Negra', cargado: false },
        { id: 'lc_21', nombre: 'Tablas de Pizzas', cantidad: 'Todas', cargado: false },
        { id: 'lc_22', nombre: 'Tablas Redondas', cantidad: '16', cargado: false },
        { id: 'lc_item_tarrina_200l', nombre: 'Tarrina 200L', cantidad: '1', cargado: false },
        { id: 'lc_19', nombre: 'Espátulas, Cuchillos de Cocina', cantidad: 'Caja Negra', cargado: false },
        { id: 'lc_25', nombre: 'Pinzas de Ensaladas', cantidad: 'Caja Negra', cargado: false },
        { id: 'lc_20', nombre: 'Escarbadientes y Saleros', cantidad: 'Caja Negra', cargado: false },
        ...
        { id: 'lc_26', nombre: 'Alcohol y Guantes', cantidad: 'Caja Negra', cargado: false },
        { id: 'lc_27', nombre: 'Repasadores', cantidad: 'Todos', cargado: false },
        { id: 'lc_28', nombre: 'Servilletas de Papel para Torta', cantidad: 'Caja Negra', cargado: false },
        { id: 'lc_29', nombre: 'Rollo Servilletas de Papel', cantidad: '2', cargado: false },
        { id: 'lc_30', nombre: 'Aderezos', cantidad: 'Todos', cargado: false },
    ...
    { id: 'cat_manteleria_1', nombre: 'Mantelería', items: [
        ...
        { id: 'lc_45', nombre: 'Cubre Azul', cantidad: '10', cargado: false },
    ...
    { id: 'cat_discoteca_1', nombre: 'Discoteca', items: [
        ...
        { id: 'lc_59', nombre: 'Caja de Consola y Potencia', cantidad: '1', cargado: false },
        ...
        { id: 'lc_115', nombre: 'Intercomunicadores', cantidad: '1', cargado: false },
        { id: 'lc_66', nombre: 'Barras de Bolas de Espejos', cantidad: '1', cargado: false },
        { id: 'lc_67', nombre: 'Bolas de Espejo', cantidad: '15', cargado: false },
        { id: 'lc_68', nombre: 'Cerchas de Luces', cantidad: '3', cargado: false },
        { id: 'lc_94', nombre: 'Tornillos Cercha', cantidad: 'Todos', cargado: false },
        { id: 'lc_69', nombre: 'Caja de Herramientas', cantidad: '1', cargado: false },
        ...
        { id: 'lc_81', nombre: 'Focos LED Luz Negra', cantidad: 'Todos', cargado: false },
        { id: 'lc_82', nombre: 'Focos LED Color', cantidad: 'Todos', cargado: false },
    ...
    { id: 'cat_barra_tragos_1', nombre: 'Barra de Tragos', items: [
        { id: 'lc_bt_1', nombre: 'Estructura de Arriba de la Barra', cantidad: '1', cargado: false },
        { id: 'lc_bt_2', nombre: 'Caja de Herramientas Barman', cantidad: '1', cargado: false },
        { id: 'lc_bt_3', nombre: 'Casilleros de Licores', cantidad: '4', cargado: false },
        { id: 'lc_bt_4', nombre: 'Refrescos Cola', cantidad: '12', cargado: false },
        { id: 'lc_bt_5', nombre: 'Refrescos Lima', cantidad: '2', cargado: false },
        { id: 'lc_bt_6', nombre: 'Lona de Barra', cantidad: '1', cargado: false },
        { id: 'lc_bt_7', nombre: 'Focos LED Luz Negra Barra', cantidad: '1', cargado: false },
        { id: 'lc_bt_8', nombre: 'Focos LED Color', cantidad: '1', cargado: false },
        { id: 'lc_bt_9', nombre: 'Licuadoras', cantidad: '2', cargado: false },
        { id: 'lc_bt_10', nombre: 'Pantalla LED Barra', cantidad: '1', cargado: false },
        { id: 'lc_bt_11', nombre: 'Papeleras', cantidad: '1', cargado: false },
        { id: 'lc_bt_12', nombre: 'Vasos y Sorbitos', cantidad: 'TODOS', cargado: false },
        { id: 'lc_bt_13', nombre: 'Tarros para Jugos', cantidad: '3', cargado: false },
        { id: 'lc_bt_14', nombre: 'Conservadora', cantidad: '1', cargado: false },
        { id: 'lc_bt_15', nombre: 'Latas de Anana', cantidad: '6', cargado: false },
        { id: 'lc_bt_16', nombre: 'Latas de Durazno', cantidad: '4', cargado: false },
        { id: 'lc_bt_17', nombre: 'Frutillas Congeladas', cantidad: '1', cargado: false },
        { id: 'lc_bt_18', nombre: 'Jugo de Durazno', cantidad: '3', cargado: false },
        { id: 'lc_bt_19', nombre: 'Azucar', cantidad: '2', cargado: false },
        { id: 'lc_bt_20', nombre: 'Limones', cantidad: '1K', cargado: false },
    ]}
];
