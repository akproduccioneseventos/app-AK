...
export const defaultContractSettings: ContractSettings = {
  ...
  clauses: [
    ...
    },
    {
      ...
      content: 'a) Solo se considerarán casos de fuerza mayor aquellos hechos extraordinarios, imprevisibles o inevitables que hagan imposible la realización del evento y puedan ser probados. b) No se considerarán fuerza mayor problemas económicos, enfermedades leves, conflictos familiares, separaciones o falta de pago. c) Si la situación configura fuerza mayor y permite reprogramar, las partes procurarán acordar una nueva fecha.',
    },
    {
